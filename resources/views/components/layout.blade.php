...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/posts" :active="request()->is('about')">POSTS</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
  ...
  <header class="bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between flex justify-between">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{$heading}}</h1>
        
        <x-button href="/register/create"> create user</x-button>
        
        <x-button href="/posts/create">create jobs</x-button>
...
<script src="https://cdn.jsdelivr.net/npm/tailwindcss@4.1.11/dist/tailwind.min.js"></script>
